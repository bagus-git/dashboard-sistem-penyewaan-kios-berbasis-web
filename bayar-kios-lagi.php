...
$dataUbah = mysqli_query($conn, "SELECT * from tb_transaksi WHERE kd_transaksi ='$kd_transaksi'");
...
<head>
    ...
    <!-- Title Page-->
    <title>bayar/transaks-kios</title>
...
<body class="animsition">
    <div class="page-wrapper">
                            ...
                            <div class="col-lg-12   ">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Transaksi /</strong> Pembayaran Tagihan Kios
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-5">
                                                    <input type="text" id="harga" value="<?php echo $data['harga']; ?>" name="harga" readonly required placeholder="Lama Sewa" class="form-control">
                                                    <!-- <span class="help-block">Please enter your password</span> -->
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-5">
                                                    <input type="text" id="total_sewa" value="<?php echo $data['total_tagihan_sewa']; ?>" name="total_sewa" required placeholder="Total sewa" class="form-control" readonly>
                                                    <!-- <span class="help-block">Please enter your password</span> -->
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-5">
                                                    <input type="text" id="kekurangan" name="kekurangan" value="<?php echo $data['tagihan']; ?>" required placeholder="Kekurangan" class="form-control" readonly>
                                                    <!-- <span class="help-block">Please enter your password</span> -->
                                                </div>
                                            </div>
                                            <?php
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="submit" value="Simpan" name="simpan" class="btn btn-success btn-sm">
        ...
        if (isset($_POST['simpan'])) {
            ...
            VALUES ('$kd_transaksi1', '$kd_penyewa1', '$nama_penyewa1','$luas1','$harga',' $lama_sewa' , '$total_tagihan1', '$kekurangan1',' $jumlah_bayar1', '$total_kekurangan1','$waktu_transaksi','$total_krng')");
