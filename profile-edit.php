...
if (isset($_POST['simpan'])) {
    ...
    $result = mysqli_query($conn, "UPDATE tb_admin SET 
                                ...
                                <div class="col-md-9 personal-info">
                                    ...
                                    <form class="form-horizontal" role="form" method="POST">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input class="form-control" type="text" name="nip" value="<?php echo $hasil['nip']; ?>" placeholder="Masukan NIP" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-3 control-label">Username:</label>
                                            <div class="col-lg-8">
                                                <input class="form-control" type="text" name="username" value="<?php echo $hasil['username']; ?>" placeholder="Masukan Username">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-3 control-label">Email:</label>
                                            <div class="col-lg-8">
                                                <input class="form-control" name="email" type="email" value="<?php echo $hasil['email']; ?>" placeholder="Masukan Email">
                                            </div>
                                        </div>
                                        <!-- <div class="form-group">
