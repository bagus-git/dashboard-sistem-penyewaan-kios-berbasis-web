...
<head>
    ...
    <!-- Title Page-->
    <title>data-laporan pertahun</title>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                ...
                                <h2 class="pageheader-title">DATA LAPORAN PERTAHUN</h2>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mb-0">Tabel Data Laporan Pertahun</h5>
                                    <br>
                                    <form action="" method="post">
                                        <select class="form-control mr-10" name="tahun">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        <table id="example" class="table table-striped table-bordered second">
                                            ...
                                            <tbody>
                                                <?php
                                                // untuk proses query menampilkan data sesuai tahun
                                                if (isset($_POST['simpan'])) {
                                                    $tahun = $_POST['tahun'];
                                                    $result = mysqli_query($conn, "SELECT * FROM tb_penyewa m INNER JOIN tb_transaksi p ON m.kd_penyewa=p.kd_penyewa WHERE waktu_transaksi like '%" . $tahun . "%' ");
                                                } else {
                                                    $result = mysqli_query($conn, "SELECT * FROM tb_penyewa m INNER JOIN tb_transaksi p ON m.kd_penyewa=p.kd_penyewa");
                                                }
