                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                ...
                                <h2 class="pageheader-title">DATA TRANSAKSI PENYEWA KIOS</h2>
                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Data Tabel Transaksi Penyewa Kios</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mb-0">Tabel Data Transaksi dan Tagihan Penyewa</h5>
                                    <br>
                                    <!-- <a href="data-penyewa-tambah.php" class="btn btn-primary btn-sm">+ Tambah Penyewa</a> -->
                                </div>
                                <div class="card-body">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td> <?php echo $data['kd_penyewa']; ?> </td>
                                                        ...
                                                        <td class=" text-center"> <?php echo $data['waktu_transaksi']; ?> </td>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <a href="<?php echo "bayar-kios-lagi.php?kd_transaksi=" . $data['kd_transaksi']; ?>" class="btn btn-success btn-sm"><i class="fa fa-user"> Bayar Tagihan</i></a> <br><br>
                                                            <!-- <a href="<?php echo "data-transaksi-edit.php?kd_transaksi=" . $data['kd_transaksi']; ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"> Edit</i></a> | -->
                                                            <a href="<?php echo "data-transaksi-delete.php?kd_transaksi=" . $data['kd_transaksi']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin mau menghapus item ini ?')"><i class="fa fa-trash"> Hapus</i></a>
