...
if (isset($_POST['simpan'])) {
    ...
    $result = mysqli_query($conn, "UPDATE tb_kepala_upt SET 
            nip='$nip', username='$username', email='$email', password='$password' WHERE nip='$nip' ");
                            ...
                            <div class="row">
                                ...
                                <!-- <div class="col-md-3">
                                    <div class="text-center">
                                        ...
                                        <!-- <img src="images/logo-admin.jpg" class="avatar img-circle" alt="avatar"> -->
                                ...
                                <div class="col-md-9 personal-info">
                                    ...
                                    <form class="form-horizontal" role="form" method="POST">
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8">
                                                <input class="form-control" type="text" name="nip" value="<?php echo  $_SESSION["tb_kepala_upt"]["nip"] ?>" placeholder="Masukan NIP" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-3 control-label">Username:</label>
                                            <div class="col-lg-8">
                                                <input class="form-control" type="text" name="username" value="<?php echo  $_SESSION["tb_kepala_upt"]["username"] ?>" placeholder="Masukan Username">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-lg-3 control-label">Email:</label>
                                            <div class="col-lg-8">
                                                <input class="form-control" name="email" type="email" value="<?php echo  $_SESSION["tb_kepala_upt"]["email"] ?>" placeholder="Masukan Email">
                                            </div>
                                        </div>
                                        <!-- <div class="form-group">
                                            <label class="col-md-3 control-label">Password:</label>
                                            <div class="col-md-8">
                                                <input class="form-control" type="" name="password" value="<?php echo $hasil['password']; ?>" placeholder="Password">
                                            </div>
                                        </div> -->
                                        <!-- <div class="form-group">
                                            <label class="col-md-3 control-label">Konfirmasi password:</label>
                                            <div class="col-md-8">
                                                <input class="form-control" type="password" value="" placeholder="Konfirmasi Password">
                                            </div>
                                        </div> -->
                                        <div class="form-group">
                                            <label class="col-md-3 control-label"></label>
                                            <div class="col-md-8">
                                                <input type="submit" name="simpan" class="btn btn-primary" value="Save Changes">
                                                <span></span>
