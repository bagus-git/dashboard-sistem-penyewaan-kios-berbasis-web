                            ...
                            <form action="" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="jenis_lahan" name="jenis_lahan" required placeholder="Masukan Jenis Lahan" class="form-control">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="luas" name="luas" required placeholder="Masukan Luas Kios" class="form-control">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="harga" name="harga" required placeholder="Masukan Harga" class="form-control">
                                        <script>
                                ...
                                <input type="submit" value="Simpan Data" name="simpan" class="btn btn-primary btn-sm">
...
if (isset($_POST['simpan'])) {
    ...
    $result = mysqli_query($conn, "INSERT INTO tb_kios(jenis_lahan,luas,harga)
            VALUES ('$jenis_lahan', '$luas', '$harga')");

    // echo '<META HTTP-EQUIV="Refresh" Content="0; URL=data-kios.php">';
    // exit;

    if (!$tambahdata) {
        echo "<script>alert('Data Kios Berhasil di Tambahkan.Data Sudah masuk dalam Laporan');window.location='data-kios.php'</script>";
    } else {
