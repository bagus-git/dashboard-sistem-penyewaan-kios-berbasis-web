...
$result = mysqli_query($conn, 'SELECT * from tb_kios');
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                ...
                                <h2 class="pageheader-title">DATA KIOS</h2>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mb-0">Tabel Data Kios</h5>
                                    <br>
                                    <a href="data-kios-tambah.php" class="btn btn-primary btn-sm"> <i class="fa fa-plus"> Tambah Data</i> </a>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table id="example" class="table table-striped table-bordered second">
                                            <thead>
                                                <tr class="text-center">
                                                    ...
                                                    <th>Jenis Lahan</th>
                                                    <th>Luas</th>
                                                    <th>Tarif Harga Sewa per Tahun</th>
                                                    <th>Aksi</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td class="text-center"> <?php echo $data['kd_lahan']; ?> </td>
                                                        <td class="text-center"> <?php echo $data['jenis_lahan']; ?> </td>
                                                        <td class="text-center"> <?php echo $data['luas']; ?> </td>
                                                        <td class="text-center"> <?php echo $data['harga']; ?> </td>
                                                        <td class="text-center">
                                                            <a href="<?php echo "data-kios-edit.php?kd_lahan=" . $data['kd_lahan']; ?>" class="btn btn-success btn-sm"><i class="fa fa-edit">Edit</i> </a> |
                                                            <a href="<?php echo "data-kios-delete.php?kd_lahan=" . $data['kd_lahan']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Anda yakin mau menghapus item ini ?')"><i class="fa fa-trash"> Hapus</i> </a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                }
