            ...
            <div class="main-content">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            ...
                            <h3><?php echo  $_SESSION["tb_kepala_upt"]["username"] ?></h3>
                            <p><?php echo  $_SESSION["tb_kepala_upt"]["email"] ?></p>
                ...
                <div class="col-md-8">
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <label for="">NIP:</label>
                            <p><?php echo  $_SESSION["tb_kepala_upt"]["nip"] ?></p>
                        </div>
                    </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <p><?php echo  $_SESSION["tb_kepala_upt"]["username"] ?></p>
                        </div>
                    </div>
